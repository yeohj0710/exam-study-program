...
![asdf](https://github.com/yeohj0710/exam-study-program/assets/93759367/795ce077-9cf8-44f9-a513-2c44d49b2361)

족보 암기 프로그램은 위와 같이 풀이한 족보를 단축키로 캡쳐하여 문제들로 만들어 쉽게 암기할 수 있는 프로그램입니다.

암기 시에는 J와 K, 2개의 키만을 이용하여 단기간에 효과적으로 암기를 진행할 수 있습니다.
...
0. [프로그램 다운로드 전 보안 설정 (선택 사항)](#0-프로그램-다운로드-전-보안-설정-선택-사항)
1. [프로그램 다운로드](#1-프로그램-다운로드)
2. [족보 폴더 사용법](#2-족보-폴더-사용법)
3. [족보 폴더 제작하는 법](#3-족보-폴더-제작하는-법)
4. 부가 기능과 프로그램 사용 문의
   - 4-1. [부가 기능: 다크 모드](#4-1-부가-기능-다크-모드)
   - 4-2. [부가 기능: 프로그램 사용 설명법 조회](#4-2-부가-기능-프로그램-사용-설명법-조회)
   - 4-3. [부가 기능: 프로그램 정보 조회](#4-3-부가-기능-프로그램-정보-조회)
   - 4-4. [프로그램 사용 문의](#4-4-프로그램-사용-문의)

<br>

### 0. 프로그램 다운로드 전 보안 설정 (선택 사항)
...
- Create Question(단축키: A키)과 Add Image(단축키: S키)는 새로운 문제를 추가할 때 필요하므로, 이미 만들어진 문제 셋을 공부하는 데에는 필요하지 않습니다. 이에 대한 사용법은 아래에서 다룹니다.
...
- 족보 암기 프로그램 창을 클릭하고, S키만 눌러줍니다. (이제부터는 같은 문제의 이미지들이니 문제 폴더를 다시 생성할 필요가 없으므로, S키만 눌러주면 됩니다.)

- 마찬가지 과정으로 나머지 보기들도 추가합니다. (역시 S키만 누릅니다.)
...
![ezgif-2-b2d375b61a](https://github.com/yeohj0710/exam-study-program/assets/93759367/56e7741e-0594-4dde-a3a1-33afc284afb9)

7. 마찬가지로 이번에는 단답형 문제의 문제 폴더를 생성해 보겠습니다. 이 경우는 보기가 없으니 문제 이미지(캡쳐 후 A, S키)와 정답 이미지(캡쳐 후 S키)만 추가하면 됩니다. 확인해 보면 문제가 잘 생성된 것을 볼 수 있습니다.

<br>

![ezgif-2-da298c05ac](https://github.com/yeohj0710/exam-study-program/assets/93759367/44f5179a-d834-4729-a8d4-c1aa8ce6754f)

8. 동일한 방법으로 나머지 문제들도 추가해 보겠습니다. 새 문제를 추가하는 경우에만 캡쳐 후 A키를 먼저 누르고 S키를 눌러주면 되고, 그 외 보기나 정답을 추가할 때는 캡쳐 후 S키만 누르면 됩니다.

<br>

9. 이런 방식으로 문제들을 모두 추가한 뒤, J, K키만 눌러가면서 편하게 암기를 하면 되겠습니다.

<br>

### 4-1. 부가 기능: 다크 모드

다크 모드는 새벽에 방에서 불을 꺼놓고 공부할 때 반드시 필요한 기능입니다.

새벽에는 눈이 아프지 않도록, 그리고 룸메이트가 깨지 않도록 다크 모드를 사용해 주세요.

![image](https://github.com/yeohj0710/exam-study-program/assets/93759367/bf7dc82a-a894-43da-a31a-2448a778c1a1)

1. 'Background Color Option'의 'Dark Mode'를 클릭해 줍니다.

<br>

![image](https://github.com/yeohj0710/exam-study-program/assets/93759367/c24fef90-4730-4e11-8d93-dd3e48be92e2)

2. 다크 모드가 잘 적용된 것을 확인할 수 있습니다.

<br>

![image](https://github.com/yeohj0710/exam-study-program/assets/93759367/a5bcb820-018b-49cc-8494-b5b7bb6ae865)

3. 다시 기존의 배경색을 적용하기 위해서는 'Background Color Option'의 'Light Mode'를 클릭해 주면 됩니다.

<br>

### 4-2. 부가 기능: 프로그램 사용 설명법 조회

![image](https://github.com/yeohj0710/exam-study-program/assets/93759367/e7926cca-932e-48d2-b5f4-a93ad128c718)

1. 프로그램 상단의 'How to Use'의 'How to Use'를 클릭해 줍니다.

<br>

![image](https://github.com/yeohj0710/exam-study-program/assets/93759367/954c511c-5f52-43ab-b352-54db080df177)

2. 팝업되는 창의 링크를 클릭하여 사용 설명법이 작성된 링크로 이동할 수 있습니다. 또한 프로그램의 업데이트가 진행되었을 수도 있으니 이를 확인하고 새로운 버전을 다운로드할 수도 있습니다.

<br>

### 4-3. 부가 기능: 프로그램 정보 조회

![image](https://github.com/yeohj0710/exam-study-program/assets/93759367/29210d5c-2f7e-4f14-93e9-dbbd9ad020ce)

1. 프로그램 상단의 'Program Information'의 'Program Information'을 클릭합니다.

<br>

![image](https://github.com/yeohj0710/exam-study-program/assets/93759367/3b020887-940e-4f4d-8505-f236244abe37)

2. 팝업되는 창을 통해 프로그램에 대한 정보를 확인할 수 있습니다.

<br>

### 4-4. 프로그램 사용 문의

프로그램 사용에 대한 문의는 yeohj0710@yonsei.ac.kr으로 남겨주세요.
